...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Device.timestamp'
        db.delete_column('ci_device', 'timestamp')

        # Adding field 'Device.first_seen'
        db.add_column('ci_device', 'first_seen',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 9, 25, 0, 0)),
                      keep_default=False)

        # Adding field 'Device.last_seen'
        db.add_column('ci_device', 'last_seen',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 9, 25, 0, 0)),
                      keep_default=False)


        # Changing field 'Device.last_update_by_snmp'
        db.alter_column('ci_device', 'last_update_by_snmp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Device.last_update_by_cli'
        db.alter_column('ci_device', 'last_update_by_cli', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
        # Deleting field 'Component.timestamp'
        db.delete_column('ci_component', 'timestamp')

        # Adding field 'Component.first_seen'
        db.add_column('ci_component', 'first_seen',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 9, 25, 0, 0)),
                      keep_default=False)

        # Adding field 'Component.last_seen'
        db.add_column('ci_component', 'last_seen',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 9, 25, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Device.timestamp'
        db.add_column('ci_device', 'timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 9, 25, 0, 0)),
                      keep_default=False)

        # Deleting field 'Device.first_seen'
        db.delete_column('ci_device', 'first_seen')

        # Deleting field 'Device.last_seen'
        db.delete_column('ci_device', 'last_seen')


        # Changing field 'Device.last_update_by_snmp'
        db.alter_column('ci_device', 'last_update_by_snmp', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Device.last_update_by_cli'
        db.alter_column('ci_device', 'last_update_by_cli', self.gf('django.db.models.fields.DateTimeField')())
        # Adding field 'Component.timestamp'
        db.add_column('ci_component', 'timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 9, 25, 0, 0)),
                      keep_default=False)

        # Deleting field 'Component.first_seen'
        db.delete_column('ci_component', 'first_seen')

        # Deleting field 'Component.last_seen'
        db.delete_column('ci_component', 'last_seen')
    ...
    models = {
        ...
        'ci.device': {
            ...
            'last_seen': ('django.db.models.fields.DateTimeField', [], {}),
            'last_update_by_cli': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'last_update_by_snmp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
