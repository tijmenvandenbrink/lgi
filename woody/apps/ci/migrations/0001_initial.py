...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ci_device', (
            ...
            ('last_update_by_cli', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('last_update_by_snmp', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
    ...
    models = {
        ...
        'ci.device': {
            ...
            'last_update_by_cli': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'last_update_by_snmp': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
